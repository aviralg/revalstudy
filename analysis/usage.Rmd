...
E_raw %>% select(
  ...
  arg_size = expr_resolved_length, #   Size in characters (unicode) of eval argument string
  type = expr_resolved_type_tag,
...
How much work is involved in each eval as measured by the number of ??? 
(possible: opcodes, AST nodes).
...
triggered %>%
  ...
  theme(text = element_text(size=20), aspect.ratio = 4/3)
