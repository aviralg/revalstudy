...
overview_table(
  ...
  r("Triggeredvalparent", trig_eval.parent),
  ...
  r("Triggeredevalqpercent", ratio(trig_eval.parent, static_eval.parent)),
  r("Localevalqpercent", ratio(trig_local, static_local))
) -> TBL
```
