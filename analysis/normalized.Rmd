...
Many call sites only evaluate a value. 
...
```{r}
with_value <- poly %>% filter(has_value(common_minimized))

val_exprs_comb <- val_exprs %>% left_join(with_value, by="src_ref")  %>%
...
val_exprs_comb %>% ggplot(aes(x = nb_caller_srcref, y = n_exprs)) + 
  geom_jitter(alpha = 0.3) +
  scale_x_log10()

val_exprs_comb %>% ggplot(aes(x = nb_runs, y = n_exprs)) + 
  geom_jitter(alpha = 0.3) +
  scale_x_log10()

val_exprs_comb %>% ggplot(aes(x = calls_per_run, y = n_exprs)) + 
  geom_jitter(alpha = 0.3) +
  scale_x_log10()

val_exprs_comb %>% ggplot(aes(x = calls_per_site, y = n_exprs)) + 
  geom_jitter(alpha = 0.3) +
  scale_x_log10()

val_exprs_comb %>% ggplot(aes(x = calls_per_site_per_run, y = n_exprs)) + 
  geom_jitter(alpha=0.3) +
  scale_x_log10()

val_exprs_comb %>% ggplot(aes(x = nb_caller_exprs, y = n_exprs)) + 
  geom_jitter(alpha=0.3) +
  scale_x_log10()
