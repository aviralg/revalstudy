...
params:
    data_filepath: "/var/lib/R/project-evalR/run/package-evals-traced-corpus.1/calls.fst"
...
```{r parse_in_base}
nb_parse_base <- eval_calls %>% filter(!is.na(expr_parsed_expression), caller_package == "base")
```

There are `r nrow(nb_parse_base)` `eval` calls in *base* 
