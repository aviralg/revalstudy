...
ast_sizes_prop <- ast_sizes %>% count(expr_resolved_ast_size, wt = nb_eval_calls) %>%
                      ...
                      arrange(expr_resolved_ast_size) %>% 
...
r("ast size nine five", nb_nodes_many$expr_resolved_ast_size)
r("ast size nine five exact percent", percent(nb_nodes_many$proportion))
