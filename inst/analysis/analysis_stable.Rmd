...
#ast_sizes <- read_fst(NODE_COUNT_FILE)
```
...
group_expr_resolved_functions <- expr_resolved_call_arg %>%
                            ...
                            mutate(group_function_expr = fct_collapse(function_expr2, 
                              ...
                              defusing = c("quote", "substitute", "bquote", "expr", "quo", "enquo", expression),
                              expressions = c("as.list", "as.name", "as.expression", "list", "c", "as.data.frame", "as.character", "{", "modify_lang"),
