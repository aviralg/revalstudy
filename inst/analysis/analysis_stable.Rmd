...
data_filepath <- EVALS_SUM_PKGS_FILE
...
The analysis is being performed on dataset read from file `r data_filepath`.

```{r file-info, echo=FALSE}
file_info(data_filepath)
```

```{r load-data, echo=FALSE}
eval_calls <-
    read_fst(data_filepath) %>%
    as_tibble() %>%
