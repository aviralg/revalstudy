...
\begin{tabular}{c|c|c|c|c|c}
  Corpus  & eval & evalq & evalParent & local & all \\
  Core & \CoreEvalCallCountRnd & \CoreEvalqCallCountRnd & \CoreEvalParentCallCountRnd & \CoreLocalCallCountRnd & \CoreAllCallCountRnd \\
  Package & \PackageEvalCallCountRnd & \PackageEvalqCallCount & \PackageEvalParentCallCountRnd & \PackageLocalCallCountRnd & \PackageAllCallCountRnd \\
\end{tabular}
