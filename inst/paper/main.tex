...
creating and evaling strings - here they assemble the call to plot function. plot is s3 generic which takes
ridiculous amount of parameters and in addition their plot function also takes parameters.
