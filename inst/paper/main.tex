...
\author{\vspace{-.8cm}\IEEEauthorblockN{\it\Large The Eval that Data Scientist Do}%
...
\begin{abstract}
  The eval function turns text into code and thus causes difficulties for
  reasoning about the behavior of software that uses it. This paper is a
  study of the usage of eval in R, a widely used data science programming
  language. We combine static and dynamic analysis on a large and
  representative corpus of R programs. Our results show...
\end{abstract}
