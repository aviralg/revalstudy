...
Over all, we observed \AllAllCallCountRnd call to \eval in \miss{3,000} runs
of our corpus. The mean number of calls per run was \miss{20} (with a min of
\miss{1} and a max of \miss{10,000}). Table~\ref{A} details the usage of
...
calls per run.  We can observe \miss{???}. {\bf <The following is a place
