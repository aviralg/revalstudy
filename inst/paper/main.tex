...
machine), \emph{CRAN packages} (these are curated packages that pass
stringent community quality checks and are equipped with tests and sample
data), \emph{scripts} (end-user written code that performs a particular
machine learning or data analysis task).
