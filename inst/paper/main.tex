...
\newcommand{\mlogit}{\texttt{mlogit}\xspace}
\newcommand{\mboost}{\texttt{mboost}\xspace}
\newcommand{\metafor}{\texttt{metafor}\xspace}
\newcommand{\lavaan}{\texttt{lavaan}\xspace}
\newcommand{\mclust}{\texttt{mclust}\xspace}
\newcommand{\gamlss}{\texttt{gamlss}\xspace}
\newcommand{\ggproto}{\texttt{ggproto}\xspace}
...
R supports reflection and meta-programming. The \c{substitute(e,envir)}
function yields the parse tree of the expression \c{e} after performing
substitutions defined by the bindings in \c{envir}.
...
first class objects. They are evaluated using the \c{eval(e,envir)}
function. Environment on the call stack can also be accessed.
...
The three other functions are defined using \eval.
