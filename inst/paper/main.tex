...
%\author{Aviral Goel}{Northeastern University, [optional: Address], Country \and My second affiliation, Country \and \url{http://www.myhomepage.edu} }{goel.aviral@gmail.com}{https://orcid.org/0000-0002-0814-5015}{(Optional) author-specific funding acknowledgements}%TODO mandatory, please use full name; only 1 author per \author macro; first two parameters are mandatory, other parameters can be empty. Please provide at least the name of the affiliation and the country. The full address is optional
...
\Copyright{Aviral Goel, Pierre Donat-Bouillud, Filip Křikava, Christoph Kirsch and Jan Vitek}
