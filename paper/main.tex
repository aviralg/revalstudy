...
The median argument size is \baseMedianszeval, which is more than for CRAN, which was dominated by symbol evaluation.The maximum size is \baseMaxszeval. Small event evals (less than 50 events) amount for \baseSmalleventspct of the events in \eval calls.
