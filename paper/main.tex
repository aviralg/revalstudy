...
\medskip\noindent\EE{$min(e)=\c{F(X)}$} This form allows function calls whose
arguments may include variable references. Assignments are excluded from this
form. It occurs in 14\% of the sites in the corpus.
