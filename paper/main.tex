...
them contain less than three \eval sites. Packages that rely heavily on \eval
are mostly the ones that provide functions for statistical modeling and
simulation. At runtime, over third of extracted programs triggered calls to
\eval. Half of the \packageAllcallsRnd recorded calls come from a single \eval
site, but for the rest, most of the packages have low \eval call frequency.
