...
were obtained by XXX runs, with runs that did not trigger \eval
discarded. Out of the \Corpus CRAN packages with \eval call sites, we
...
over all runs that invoked functions in that package. Out of the XXX
packages in the corpus, XXX call have a low frequency of \eval calls,
with fewer than 100 of them. On the other hand, XXX packages call eval
more than 1,000 times, with one package (???) calling it XXXX times.
