...
\begin{figure}[h!]
	\centering
	\includegraphics[width=.5\textwidth]{events_per_pack_small}
	\hspace{-5mm}
	\includegraphics[width=.5\textwidth]{events_per_pack_large}
...
\begin{itemize}
\item Increase font size on numbers for figures
\item change colors on figure 8 (don't like the red)
