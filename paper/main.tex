...
Similarly, when a function is evaluated on some variable (\c{F(X)}), the percentage of non default environment is high, \packageMinimizedpercentenvird\%.
...
\paragraph{Sequence of statements.} \c{\{BLOCK\}} is a sequence of statements. It is usually large, with in average \packageMinimizedoperationsjRnd operations in it.
