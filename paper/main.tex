...
call-sites which contribute to 90\% of the eval calls. We describe the common
...
\textit{Core function variants.} Many packages use \eval to implement variations of the
