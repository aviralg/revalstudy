...
One site could appear in several categories. However, most sites, \ie
\packageNbOneCategoryEnvirSitePercent, have only kind of the above environments
passed to them, as shown in Table~\ref{tab:polyenvir}.
