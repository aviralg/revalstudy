...
% Updated with the last run
% I made some changes and we need another run to get the right results
% The difference should be that there will much more package environments
% the loop category should disappear from the top results also.
...
\begin{tabular}{|c|c|c|}
    ...
    \hline
    % Should be many more (next run)
    Package/namespace & \packageNbPackageEnvSites & \packagePackageEnvSitePercent \\
    \hline
