...
is the average number of instructions performed by the interpreter; and \%envir
...
%% JAN: simplifying osme mumers and adding %
\c X&\packageMinimizedcallsitesa & 28\% &\packageMinimizedpackagea & 768 &77\% & \c{y+1}\\\hline
\c{F(F(X))} & \packageMinimizedcallsitesb  & 20\% & \packageMinimizedpackageb  & 466K & 55\% & \c{gbov( mean(x), a-1)}\\\hline
\c{V}&\packageMinimizedcallsitesc & 17\% &\packageMinimizedpackagec &\packageMinimizedoperationscRnd & 71\%& \c{c(42,21,0)}\\\hline
\c{F(X)}& \packageMinimizedcallsitesd & 14\% & \packageMinimizedpackaged & \packageMinimizedoperationsdRnd & 75\% & \c{seq\_len(iters)} \\\hline
\c{model.frame} & \packageMinimizedcallsitese & 7\% & \packageMinimizedpackagee & 3K & 21\% & \c{model.frame(formula = Z ~ U)} \\\hline
\c{F()}& \packageMinimizedcallsitesf & 6\% & \packageMinimizedpackagef & \packageMinimizedoperationsfRnd & 73\% & \c{rgamma(3, 2, n = 10L)} \\\hline
\c{\$}& \packageMinimizedcallsitesg & 6\% & \packageMinimizedpackageg & 2K & 78\% & \c{DF\$B} \\\hline
\c{FUN} & \packageMinimizedcallsitesh & 6\% & \packageMinimizedpackageh & \packageMinimizedoperationshRnd & 23\% & \c{function(x, y) x + 3 * y} \\\hline
\c{<-} & \packageMinimizedcallsitesi  & 5\% & \packageMinimizedpackagei & 11K & 73\% & \c{x[1, 2:3, 2:3] <- value}\\\hline
\c{BLOCK} & \packageMinimizedcallsitesj & 4\% & \packageMinimizedpackagej & 440K & 73\% & \c{\{ write.csv(iris, tf); file.size(tf) \}} \\\hline
