...
over all runs that invoked functions in that package. Out of the \Corpus
packages in the corpus, \EvalCallsLessHundred packages have a low frequency of \eval calls,
with fewer than 100 of them. On the other hand, \EvalCallsMoreThousand packages call eval
more than 1,000 times, with one package (\MaxEvalCallPackage) calling it \MaxEvalCallsRnd times.
