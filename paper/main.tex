...
\begin{itemize}
\item {\it Promise:} Function arguments are passed as promises, suspended
  computations, from a promise one can retrieve the source expression with a
  call to the \c{substitute} function.
...
\item {\it Constructed:} Expressions can be constructed by invoking the
  \c{quote}, \c{enquote} and \c{expression} functions.
...
Promise & \packageNbOtherLangsSites & \packageOtherLangsSitePercent \\ \hline
Parse & ?& ?\\ \hline
