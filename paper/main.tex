...
recurring uses of \eval by packages that do statistical modeling, \ie the
\c{model.frame} shape in Table~\ref{tab:minimizedexpressions}.
...
wrappers.\footnote{Private communication with a developer of R.} Wrapping
functions in R is somewhat harder than in other languages because of default
arguments, varargs and missing arguments.
