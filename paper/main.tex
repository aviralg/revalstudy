...
a list, a dataframe, a pairlist or even an integer. Most of the time, \ie in
\packageEnvirEnvSitePercent of the sites, \eval is passed an actual environment.
...
makes \eval fail. \c{NULL}, a \c{list} or a data frame, or an integer, happen in
