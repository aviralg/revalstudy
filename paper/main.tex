...
\todo{Show also an example with \c{substitute}}
...
\todo{There is an example in package comprenhr that does code generation with substitute to create list comprehensions, but it is quite difficult to grasp.}
