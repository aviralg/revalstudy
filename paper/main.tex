...
A common use of \eval is to \emph{simplify interfaces} by letting users pass string
argument which can be parsed and evaluated in custom a environment. An example
is the \code{rARS} function from the \code{AdapSamp} package, shown below.
