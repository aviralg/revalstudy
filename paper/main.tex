...
evaluation of the rest of the function. For instance, it can inject a \c{break} or \c{next} instructions in a loop. It is very rare however, as it happens only twice in our dataset. % What kind of non-local returns?
% eval(quote(return(89))) does not work 
...
% TODO: numbers on the prevalence of the pattern
...
% This is actually linked to NSE, as the symbol given to \eval usually comes
% from match.call or susbtitute

\subsection{Non-Standard Evaluation} % Or metaprogramming
