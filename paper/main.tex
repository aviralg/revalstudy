...
Similarly, when a function is evaluated on some variable (\c{F(X)} minimized expression), the percentage of non default environment is high, \packageMinimizedpercentenvird\%.
