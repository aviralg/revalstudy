...
offset on the call stack. Thus 0 is the direct caller and corresponds to local variables and to \emph{lexical scoping}; 1 is its parent, and
so on, and correspond to \emph{dynamic scoping}. The data suggests that in 81\% of cases, \eval access its caller's environment -- this means, the variables of the function where \eval textually
...
environment to add variables global the package.
