...
\subsection{The environment passed to \eval.}
...
Minimized expression \texttt{\$} refers to a slot access, with \texttt{\$}, \texttt{[]} or \texttt{[[]]}, as the top call in a simple expression, for instance \texttt{a\$slot + 1} and  It amounts for \packageNbSlotAccess sites, \ie \packageSlotAccessPercent of the sites.
