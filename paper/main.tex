...
The calls happening in a function environment are mostly happening in the environment of the function calling \eval, as shown in Table%TODO


%TODO: add here table of possible frame numbers
...
%TODO: add here table of possible environment categories wrapped in new
...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|}
        ...
        \hline
    \end{tabular}
\caption{Classification of environments wrapped by one of several \c{new}, in number of sites. Some sites can be passed more than one kind of environments. }
\end{table}
