...
It is the predominant usage of \eval in Base, through function \c{match.args}. In CRAN, it correlates with more exotic environments passed to \eval. \todo{THis is with a V in practice.}
The dominant site in numbers of calls in CRAN, in the custom object system of \emph{ggplot2}, \c{ggproto}, also evaluates a variable \c{`\_inherit`} in the definition environment of the class. It leads to a large diversity of environments, many being package environments or package environments wrapped in \c{new}.
\todo{Explain why they use eval and not get... because of \c{::}}
