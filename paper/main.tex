...
\end{minipage}
\end{table}
One site could appear in several categories. However, most sites, \ie \packageNbOneCategoryEnvirSitePercent, have only kind of the above environments passed to them.
