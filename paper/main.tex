...
\end{itemize}
We also consider an orthogonal category: environments built with \c{new.env}. They can have as parent an environment of any of the other categories or another environment built with \c{new.env}.
