...
\k{do.call} function to build function calls. However, the unnecessary uses of
...
in this case, a semantically equivalent function body uses \k{get} to perform
the lookup and then calls the resulting function directly.
