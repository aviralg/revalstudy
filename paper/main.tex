...
\c{paste} concatenates strings and \eval will just return that string. \c{as.formula} can take a string and convert it to a formula; \eval is not needed here. In 20 random sites among the ones with values, a conservative manual inspection showed that \packageUsefulValueEvalPercent of the sites  had a  good reason to use \eval.
