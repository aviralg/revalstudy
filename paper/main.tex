...
%
We do not get source locations for \UndefinedEvalsRnd UPDATE!! \eval calls. In
...
\PercentUndefinedEval UPDATE!! of all \eval calls and is unlikely to affect our
...
\begin{figure}[h!]
 \includegraphics[width=0.5\textwidth, trim=5.5cm 0 6cm 0, clip]{size_loaded_distribution}
