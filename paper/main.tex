...
documentation, and use-cases called \emph{vignettes}. All runnable snippets can
be extracted into independent files. We download \CranPackages packages and
...
vignettes and \CranRunnableCodeTestsRnd in tests). CRAN packages are authored by
...
We recorded \baseAllcalls \eval calls in the base libraries. This
