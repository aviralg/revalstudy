...
This corresponds to minimized expressions \c{X}, \c{V}. We also include here lookup to slots in a list or data frame, \ie minimized expression \c{\$}. Variable lookup leads to a large diversity of environments, many being package environments or package environments wrapped in \c{new}.
...
\todo{Show an actual example with \$}
...
\end{lstlisting} 
 ...
 \todo{Add an example of a plot with parse from Kaggle}
