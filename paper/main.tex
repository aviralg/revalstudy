...
\begin{minipage}{.3\textwidth}
  \vspace*{14mm}
  \hspace*{-10mm}
  \includegraphics[width=1.5\textwidth]{pkgs-eval-callsites-hist.pdf} \caption{CRAN
  \eval call sites}%
  \label{fig:pkgs-eval-callsites-hist}
\end{minipage}
\begin{minipage}{.6\textwidth}
  \centering
  \includegraphics[width=\textwidth]{traced-eval-callsites.pdf}
...
% Explain tha some generate expression objects and other language objects?
...
% \packageUnknownProvSitePercent : provenance not relavant (values, symbols etc)
